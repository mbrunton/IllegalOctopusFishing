...
TODO: 
- implement app controls (tilting tablet for steering, swiping screen up/down to adjust sail slack)
 - currently uses keyboard (left, right arrows to steer, up, down arrows to adjust sail slack, space to fire harpoon)
...
- wind updates randomly every 20 seconds

How I modeled entities
- terrain and ocean defined by vertices created at runtime
